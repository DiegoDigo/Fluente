...
public class FloatContractTests {
    ...
    public void isGreaterThan() {
        Contract nullOrEmpty = new Contract()
                .required()
                .isGreaterThan(BigDecimal.ZERO, 10F, "string", "string is null");
    ...
    public void isGreaterThan_double() {
        Contract nullOrEmpty = new Contract()
                .required()
                .isGreaterThan(0.0, 10F, "string", "string is null");
    ...
    public void isGreaterThan_float() {
        Contract nullOrEmpty = new Contract()
                .required()
                .isGreaterThan(0f, 10F, "string", "string is null");
    ...
    public void isGreaterThan_long() {
        Contract nullOrEmpty = new Contract()
                .required()
                .isGreaterThan(0L, 10F, "string", "string is null");
    ...
    public void isGreaterThan_int() {
        Contract nullOrEmpty = new Contract()
                .required()
                .isGreaterThan(0, 10F, "string", "string is null");
    ...
    public void isGreaterOrEqualsThan(final double entry) {
        Contract nullOrEmpty = new Contract()
                .required()
                .isGreaterOrEqualsThan(new BigDecimal(entry), 10F, "string", "string is null");
    ...
    public void isGreaterOrEqualsThan_double(final double entry) {
        Contract nullOrEmpty = new Contract()
                .required()
                .isGreaterOrEqualsThan(entry, 10F, "string", "string is null");
    ...
    public void isLowerThan(final double entry) {
        Contract nullOrEmpty = new Contract()
                .required()
                .isLowerThan(new BigDecimal(entry), 0F, "string", "string is null");
    ...
    public void isLowerThan_double(final double entry) {
        Contract nullOrEmpty = new Contract()
                .required()
                .isLowerThan(entry, 0F, "string", "string is null");
    ...
    public void isLowerOrEqualsThan(final Double enrty) {
        Contract nullOrEmpty = new Contract()
                .required()
                .isLowerOrEqualsThan(new BigDecimal(enrty), 1F, "string", "string is null");
    ...
    public void isLowerOrEqualsThan_double(final Double entry) {
        Contract nullOrEmpty = new Contract()
                .required()
                .isLowerOrEqualsThan(entry, 1F, "string", "string is null");
    ...
    public void isEquals() {
        Contract nullOrEmpty = new Contract()
                .required()
                .isEquals(BigDecimal.ONE, 1F, "string", "string is null");
    ...
    public void isEquals_double() {
        Contract nullOrEmpty = new Contract()
                .required()
                .isEquals(1.0, 1F, "string", "string is null");
    ...
    public void isEquals_float() {
        Contract nullOrEmpty = new Contract()
                .required()
                .isEquals(1F, 1F, "string", "string is null");
    ...
    public void isEquals_Long() {
        Contract nullOrEmpty = new Contract()
                .required()
                .isEquals(1L, 1F, "string", "string is null");
    ...
    public void isLowerOrEqualsThan_int() {
        Contract nullOrEmpty = new Contract()
                .required()
                .isEquals(1, 1F, "string", "string is null");
    ...
    public void isNotEquals() {
        Contract nullOrEmpty = new Contract()
                .required()
                .isNotEquals(10.0, 1F, "string", "string is null");
    ...
    public void isNotEquals_float() {
        Contract nullOrEmpty = new Contract()
                .required()
                .isNotEquals(10F, 1F, "string", "string is null");
    ...
    public void isNotEquals_Long() {
        Contract nullOrEmpty = new Contract()
                .required()
                .isNotEquals(10L, 1F, "string", "string is null");
    ...
    public void isNotEquals_int() {
        Contract nullOrEmpty = new Contract()
                .required()
                .isNotEquals(10, 1F, "string", "string is null");
    ...
    public void isBetween() {
        Contract nullOrEmpty = new Contract()
                .required()
                .isBetween(10F, 0F, 10F, "string", "string is null");
    ...
    public void isNullOrNullable() {
        Contract nullOrEmpty = new Contract()
                .required()
                .isNullOrNullable((Float) null, "string", "string is null");
